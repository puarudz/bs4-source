...
<!-- /./ -->
<div class="card">
<div class="card-header"><h5 class="card-title">Đăng nhập hệ thống</h5></div>
<div class="card-body">
   <form action="javascript:volid()" method="POST">
        <div class="form-group">
          <label for="username"><i class="fa fa-user"></i> Điền username để đăng nhập:</label>
        ...
        <div class="form-group">
          <label for="password"><i class="fa fa-lock"></i> Điền mật khẩu để đăng nhập:</label>
        ...
        <button type="submit" id="submit" class="btn-sm btn-info"> ĐĂNG NHẬP HỆ THỐNG</button>
      </form>
      </div>
    <div class="card-footer">
      <small class="h6 form-text text-muted">Chưa có tài khoản <a href="dang-ky-he-thong">Tạo tài khoản</a></small>
    </div>
</div>
</div>
